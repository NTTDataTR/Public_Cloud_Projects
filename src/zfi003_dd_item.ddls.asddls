...
define abstract entity ZFI003_DD_Item
{
  ...
  key item              : abap.int4;
      ...
      tax_code          : zfi003_de_tax_code;
      profit_center     : abap.char(10);
      cost_center       : abap.char(10);

      _parent           : association to parent ZFI003_DD_Header on _parent.dummy_key = $projection.dummy_key;
